Este documento está disponível nos seguintes idiomas: [russo (ru-RU)](/other-langs/LICENSE_ru-RU.md), [inglês americano (en-US)](/LICENSE.md), [ucraniano (uk-UA)](/other-langs/LICENSE_uk-UA.md), **português brasileiro (pt-BR)**, [espanhol mexicano (es-MX)](/other-langs/LICENSE_es-MX.md).
...
* * * * aumento do número de missões/tarefas do jogo (em 20% ou mais do número no projeto original);
...
* * o nome do titular dos direitos do projeto original (obrigatório para modificações, mas pode não ser indicado em certos casos conforme as seções [Nº 1](/other-langs/TERMS_OF_USE_pt-BR.md#1-uso-em-mídia-e-transmissões-ao-vivo) e [Nº 2](/other-langs/TERMS_OF_USE_pt-BR.md#2-uso-de-recursos-de-mídia) dos [Termos de Uso](/other-langs/TERMS_OF_USE_pt-BR.md);
...
> **Nota:** exemplos de atribuição adequada podem ser encontrados no documento ["Exemplos de Atribuição"](/other-langs/ATTRIBUTION_pt-BR.md).
...
* o uso comercial do projeto é dividido nas seguintes categorias:
...
## 6. Contribuições da Comunidade e Uso de Ideias
...
A parte restante está estabelecida nas [diretrizes de contribuição](/other-langs/CONTRIBUTING_pt-BR.md). Ao fornecer uma contribuição, você concorda com os termos desta licença e reconhece o direito do titular dos direitos de usar suas ideias no projeto original.
...
* * quando distribuídas sob outra licença – manter os requisitos desta licença em relação à atribuição, respeito aos direitos autorais e uso comercial (seções [#1](#1-autoria-e-atribuição), [#3](#3-uso-comercial), [#5](#5-distribuição) e [seção #2 dos Termos de Uso](/other-langs/TERMS_OF_USE_pt-BR.md#2-uso-de-recursos-de-mídia));
...
Informações sobre a compatibilidade desta licença com outras licenças estão descritas nas [diretrizes de contribuição](/other-langs/CONTRIBUTING_pt-BR.md). Ao usar componentes de terceiros, é necessário seguir os princípios de preservação das condições de suas licenças.
...
* * usar o projeto de qualquer maneira proibida na [seção Usos Proibidos](/other-langs/TERMS_OF_USE_pt-BR.md#4-usos-proibidos) dos [Termos de Uso do projeto](/other-langs/TERMS_OF_USE_pt-BR.md);
...
* * declarar publicamente uma violação da licença;
...
* [⚒️ termos de uso](/other-langs/TERMS_OF_USE_pt-BR.md) — regras para aplicação do projeto em vários cenários,
* [🤝 diretrizes de contribuição](/other-langs/CONTRIBUTING_pt-BR.md) — regras para colaboradores e colaboração,
* [👤 exemplos de atribuição](/other-langs/ATTRIBUTION_pt-BR.md) — como indicar corretamente a autoria ao usar o projeto.
