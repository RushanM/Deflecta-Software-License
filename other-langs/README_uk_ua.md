...
2.1. `ПРАВООБЛАДАТЕЛЬ`/`COPYRIGHT_HOLDER` на ваше ім'я або назву організації.
2.2. `НОМЕР_ГОДА`/`YEAR_NUMBER` на поточний рік.
2.3. `НАЗВАНИЕ_ГОСУДАРСТВА`/`STATE_NAME` на вашу державу проживання.
2.4. `АДРЕС_ПОЧТЫ`/`EMAIL` на вашу електронну адресу.
2.5. `НАЗВАНИЕ_ПРОЕКТА`/`PROJECT_NAME` на назву вашого проєкту.
3. Готово.
