...
* * ім'я правовласника оригінального проекту (обов'язково для модифікацій, але може не вказуватися в окремих випадках згідно з розділами [№ 1](/other-langs/TERMS_OF_USE_uk-UA.md#1-використання-в-медіа-та-прямих-трансляціях) та [№ 2](/other-langs/TERMS_OF_USE_uk-UA.md#2-використання-медіаресурсів) [умов використання](/other-langs/TERMS_OF_USE_uk-UA.md);
