...
**Значні зміни** — зміни, які в сукупності переводять проект з модифікації/латки в самостійний комерційно реалізований продукт. Для об'єктивної оцінки беруться до уваги такі критерії:

* **критерій ігрового контенту:** достатньо виконання хоча б однієї з умов:
* * додавання нових ігрових рівнів, глав або сюжетних елементів, що суттєво розширюють ігровий досвід (20% і більше від обсягу оригінального проекту). Це може вимірюватися такими способами:
