Цей документ доступний наступними мовами: [російська (ru-ru)](/TERMS_OF_USE_ru-ru.md), **українська (uk-ua)**, [американська англійська (en-us)](/TERMS_OF_USE.md), [бразильська португальська (pt-br)](/TERMS_OF_USE_pt-br.md), [мексиканська іспанська (es-mx)](/TERMS_OF_USE_es-mx.md).

# Умови використання проєкту від 2025 року

> **Важливо**: даний документ доповнює основну [ліцензію проєкту](/LICENSE_uk-ua.md) і уточнює правила використання в конкретних сценаріях. При виникненні протиріч між цим документом і ліцензією, пріоритет має ліцензія.
...
* дозволяється використання персонажів, сетингу, сюжетних елементів і візуального стилю проєкту в сторонніх роботах (іграх, що не є модифікаціями даного проєкту, творах мистецтва, літературних творах) за дотримання наступних умов:
