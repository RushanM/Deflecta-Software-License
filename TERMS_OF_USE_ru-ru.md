Этот документ доступен на следующих языках: **русский (ru-ru)**, [украинский (uk-ua)](/TERMS_OF_USE_uk-ua.md), [американский английский (en-us)](/TERMS_OF_USE.md), [португальский бразильский (pt-br)](/TERMS_OF_USE_pt-br.md), [мексиканский испанский (es-mx)](/TERMS_OF_USE_es-mx.md).

# Условия использования проекта от 2025 года

> **Важно**: данный документ дополняет основную [лицензию проекта](/LICENSE_ru-ru.md) и уточняет правила использования в конкретных сценариях. При возникновении противоречий между этим документом и лицензией, приоритет имеет лицензия.
